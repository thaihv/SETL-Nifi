...
public class GSSResultSetRecordSet implements RecordSet, Closeable {
    private static final Logger logger = LoggerFactory.getLogger(GSSResultSetRecordSet.class);
    ...
    public GSSResultSetRecordSet(final ResultSet rs, final RecordSchema readerSchema, final int defaultPrecision, final int defaultScale) throws SQLException {
        this(rs, readerSchema, defaultPrecision, defaultScale, true);
    }

    public GSSResultSetRecordSet(final ResultSet rs, final RecordSchema readerSchema, final int defaultPrecision, final int defaultScale, final boolean useLogicalTypes) throws SQLException {
    ...
    protected Record createRecord(final ResultSet rs) throws SQLException, ParseException {
        final Map<String, Object> values = new HashMap<>(schema.getFieldCount());

        IGSSResultSet gssResultSet = (IGSSResultSet) rs;
        IGSSResultSetMetaData rsmd = gssResultSet.getMetaData();
