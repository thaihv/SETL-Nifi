...
@PrimaryNodeOnly
public class FetchPostGIS extends AbstractQueryPostGISTable {
    ...
    protected SqlWriter configureSqlWriter(ProcessSession session, ProcessContext context) {
        ...
        return new RecordPostGISWriter(recordSetWriterFactory, options, maxRowsPerFlowFile, Collections.emptyMap());
    }
}
