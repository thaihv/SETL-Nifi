...
public class ShpReader extends AbstractProcessor {
	...
	public static final PropertyDescriptor MY_PROPERTY = new PropertyDescriptor.Builder().name("shapefile")
			.displayName("ShapeFile")
			.description("Read records from a given shape file and represent geospatial data in WKT format.")
			.required(true).addValidator(StandardValidators.NON_EMPTY_VALIDATOR).build();
	public static final PropertyDescriptor REGEX = new PropertyDescriptor.Builder().name("REGEX").displayName("REGEX")
			.description("REGEX").required(true).addValidator(StandardValidators.NON_EMPTY_VALIDATOR).build();
	public static final PropertyDescriptor PASS = new PropertyDescriptor.Builder().name("PASS").displayName("Password")
			.description("Example Property").required(true).sensitive(true)
	...
	public static final Relationship REL_FAILURE = new Relationship.Builder().name("REL_FAILURE")
			.description("A Flowfile is routed to this relationship it can not be parsed or a problem happens").build();
